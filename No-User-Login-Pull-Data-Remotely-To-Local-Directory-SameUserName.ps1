...
$Curr_date = Get-Date
$Max_days = "-730"  # this is the number of days previous of the date that you run this that the script will copy to the Local directories.  
...
$Ldesk = "C:\Users\mig\Desktop\"

# Remote Documents
$Rdocs = "\\$comp\C$\Users\$user\Documents\"
# Local Documents
$Ldocs = "C:\Users\mig\$user\Documents\"

# Remote Pictures
$Rpics = "\\$comp\C$\Users\$user\Pictures\"
# Local Pictures
$Lpics = "C:\Users\mig\$user\Pictures\"
